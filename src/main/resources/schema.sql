CREATE TABLE COTIZACIONES (MONEDA VARCHAR(10) PRIMARY KEY,
                           TASA_CAMBIO FLOAT NOT NULL);
CREATE TABLE TARJETAS (ID BIGINT AUTO_INCREMENT PRIMARY KEY,
                       NUMERO VARCHAR(16) NOT NULL UNIQUE,
                       TITULAR VARCHAR(100) NOT NULL,
                       LIMITE_CREDITO FLOAT NOT NULL);
CREATE TABLE CONSUMOS (ID BIGINT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE LIQUIDACIONES (ID BIGINT AUTO_INCREMENT PRIMARY KEY,
                            ID_TARJETA BIGINT NOT NULL,
                            MES INT NOT NULL,
                            ANIO INT NOT NULL,
